...
from chromatopy.hplc_integration_gen import hplc_integration_gen
from chromatopy.config.Integration_Settings import load_integration_settings, open_integration_settings
from chromatopy.config.Plot_Settings import load_plot_settings, open_plot_settings
...
class ChromatoPyApp(toga.App):
    ...
    def startup(self):
        ...
        # Error / status label
        self.error_label = toga.Label("", style=Pack(color="#EA0F0B", margin=(30, 300, 20, 20), font_weight="bold", font_size=12))
