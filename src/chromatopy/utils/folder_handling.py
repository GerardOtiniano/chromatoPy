...
from .GDGT_compounds import load_gdgt_metadata_from_config

def folder_handling(folder_path, gdgt_meta_set=None):
    """
    ...
    gdgt_meta_set = load_gdgt_metadata_from_config() #get_gdgt(gdgt_oi)  # Ensure get_gdgt is defined or imported
