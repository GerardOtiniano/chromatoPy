...
#     df["%tetra"] = tetra_ / sum_ if sum_ is not None else np.nan
#     df["%penta"] = penta_ / sum_ if sum_ is not None else np.nan
#     df["%hexa"] = hexa_ / sum_ if sum_ is not None else np.nan

#     # Indices
#     df["MBT'5Me"] = (df_fa.get("Ia", 0) + df_fa.get("Ib", 0) + df_fa.get("Ic", 0)) / (df_fa.get("Ia", 0) + df_fa.get("Ib", 0) + df_fa.get("Ic", 0) + df_fa.get("IIa", 0) + df_fa.get("IIb", 0) + df_fa.get("IIc", 0) + df_fa.get("IIIa", 0))
#     df["CBT5Me"] = -np.log10((df_fa.get("Ib", 0) + df_fa.get("IIb", 0)) / (df_fa.get("Ia", 0) + df_fa.get("IIa", 0)))
#     df["CBT'"] = -np.log10((df_fa.get("Ic", 0) + df_fa.get("IIa'", 0) + df_fa.get("IIb'", 0) + df_fa.get("IIc'", 0) + df_fa.get("IIIa'", 0) + df_fa.get("IIIb'", 0) + df_fa.get("IIIc'", 0)) / (df_fa.get("Ia", 0) + df_fa.get("IIa", 0) + df_fa.get("IIIa", 0)))
#     df["DC"] = (df_fa.get("Ib", 0) + df_fa.get("IIb", 0) + df_fa.get("IIb'", 0)) / (df_fa.get("Ia", 0) + df_fa.get("IIa", 0) + df_fa.get("IIa'", 0) + df_fa.get("Ib", 0) + df_fa.get("IIb", 0) + df_fa.get("IIb'", 0))
#     df["cald/cren"] = df_fa.get("GDGT-0", 0) / df_fa.get("GDGT-4", 1)  # Avoid division by zero
#     df["HP5"] = df_fa.get("IIIa", 0) / (df_fa.get("IIa", 0) + df_fa.get("IIIa", 1))  # Avoid division by zero
#     df["BIT"] = (df_fa.get("Ia", 0) + df_fa.get("IIa", 0) + df_fa.get("IIIa", 0)) / (df_fa.get("Ia", 0) + df_fa.get("IIa", 0) + df_fa.get("IIIa", 0) + df_fa.get("GDGT-4", 1))
#     df["IR"] = (df_fa.get("IIa'", 0) + df_fa.get("IIb'", 0) + df_fa.get("IIc'", 0) + df_fa.get("IIIa'", 0) + df_fa.get("IIIb'", 0) + df_fa.get("IIIc'", 0)) / (
#         df_fa.get("IIa'", 0) + df_fa.get("IIb'", 0) + df_fa.get("IIc'", 0) + df_fa.get("IIIa'", 0) + df_fa.get("IIIb'", 0) + df_fa.get("IIIc'", 0) + df_fa.get("IIa", 0) + df_fa.get("IIb", 0) + df_fa.get("IIc", 0) + df_fa.get("IIIa", 0) + df_fa.get("IIIb", 0) + df_fa.get("IIIc", 0)
#     )
#     df["MI"] = (df_fa.get("GDGT-1", 0) + df_fa.get("GDGT-2", 0) + df_fa.get("GDGT-3", 0)) / (df_fa.get("GDGT-1", 0) + df_fa.get("GDGT-2", 0) + df_fa.get("GDGT-3", 0) + df_fa.get("GDGT-4", 0) + df_fa.get("GDGT-4'", 0))
#     df["fC"] = 0.5 * (
#         (df_fa.get("Ib", 0) + df_fa.get("IIb", 0) + df_fa.get("IIb'", 0) + df_fa.get("IIIb", 0) + df_fa.get("IIIb'", 0) + 2 * (df_fa.get("Ic", 0) + df_fa.get("IIc", 0) + df_fa.get("IIc'", 0) + df_fa.get("IIIc", 0) + df_fa.get("IIIc'", 0)))
#         / (
#             df_fa.get("Ia", 0)
#             + df_fa.get("Ib", 0)
#             + df_fa.get("Ic", 0)
